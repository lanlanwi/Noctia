import { copyText, delegateEvent } from '../internal';

function getText(elm: HTMLElement): string {
...
function handleDataCopy(_: Event, elm: Element) {
...
function handleCopyTarget(_: Event, elm: Element) {
  if (!(elm instanceof HTMLElement)) return;
...
const DELEGATE_ID_TARGET = 'data-copy-target-id';
